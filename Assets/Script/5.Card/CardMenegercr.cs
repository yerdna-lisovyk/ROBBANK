...
public class CardMenegercr : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        AllCards.Add(new Card("Сапог скороход", "Добавляет 2 клетки к ходу.", "Simple Buttons/RPG_inventory_icons/boots", Card.TypeCard.EQUIPMENT,Card.TypeEquipment.BOOTS,Card.TypeBoots.BOOTS_OF_SPEED));
